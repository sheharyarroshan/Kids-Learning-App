...
class Shapequiz extends StatefulWidget {
  @override
  State<Shapequiz> createState() => _ShapequizState();
}
            ...
            children: [
              Flexible(
                child: PageView.builder(
                  ...
                  itemCount: shapequestion.length,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: GridView.count(
                            ...
                            children: [
                              for (int i = 0;
                                  i < shapequestion[index].answer.length;
                                  i++)
                                MaterialButton(
