  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Center(child: Text('Month',style: TextStyle(color: Colors.black,fontFamily: "arlrdbd"),)),
        ),
        body: Padding(
                    ...
                    child: Card(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Text(monthlist[index].Text, style: TextStyle(color: Colors.black,fontFamily: "arlrdbd"),)
                          ]
                      ),
                    )
                );
