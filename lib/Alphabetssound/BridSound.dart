  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
        appBar: AppBar(
          elevation: 0,
          title: Text(
              'Bird',style: TextStyle(color: Colors.black,fontFamily: "arlrdbd"),
          ),
                      ...
                      child: Card(
                        ...
                        child: PageView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index1) {
                            return Center(
                              child: Image.asset(bridslist[widget.index1].image,alignment: Alignment.topCenter,),
