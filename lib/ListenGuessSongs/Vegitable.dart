...
class VegitableSong extends StatefulWidget {
  @override
  State<VegitableSong> createState() => _VegitableSongState();
}

List<Numbermodel> vegitablelist = vegitable1();

class _VegitableSongState extends State<VegitableSong> {
                      ...
                      children: [
                            ...
                            children: [
                              for (int i = 0;
                                ...
                                MaterialButton(
                                  ...
                                  child: Image(
                                    image: AssetImage(vegitablesongs2[index]
                                        .answer
                                        .keys
                                        .toList()[i]),
                                    height: 100,
                        ...
                        Column(
                            ...
                            children: [
                              InkWell(
                                  onTap: () => flutterTts
                                      .speak(vegitablelist[index].Text),
                                  child: Image.asset(
